          ...
          <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.assignmentDetails}>
              ...
              {assignment.assignment_file_url && (
                <TouchableOpacity
                  style={[styles.downloadButton, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}
            ...
            {hasSubmissions && (
              <View style={styles.submissionsSection}>
                ...
                {mySubmissions.map((submission, index) => (
                  <View key={submission.submission_id} style={[styles.submissionItem, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
